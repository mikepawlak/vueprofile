  ...
  <section class="section project-section">
    <div class="container">
      <div class="box">
        ...
        <p>This portfolio site is also my most recent project. It was built by me in its entirety and I’ve made the source code available on <a href='https://github.com/mikepawlak/vueprofile'>Github</a>.</p>
      </div>
